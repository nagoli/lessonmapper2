...
public abstract class BipartiteRankBoostAbstract extends RankBoostRanker{
	 ...
	 * 
	 */
	static public boolean isLongTraining = false;
	...
	public BipartiteRankBoostAbstract(int aRoundNb, List<LOMRanking> aQueryList,
		...
		itsHypothesisAndAlphaList = new LinkedHashMap<Hypothesis, Double>();
	 ...
	 * @return 
	 */
	public abstract Couple<Hypothesis, Double> weakLearn(List<Couple<LOMRanking, LOM>> aLOMList, BipartiteDistribution aDistribution, List<Ranker> aRankerList) ;
	...
	public BipartiteDistribution nextRound(BipartiteDistribution theDistribution) {
		Couple<Hypothesis, Double> theCouple = weakLearn(itsWholeLOMList,
		...
		double alpha = getAlpha(theCouple.getLeftElement()); 
		itsHypothesisAndAlphaList.put(theCouple.getLeftElement(),theCouple.getRightElement()+(alpha));
	...
	public double getAlpha(double r) {
		return Math.log((ONE+r)/(ONE-(r)))/(TWO);
	}
	 ...
	 * @return 
	 */
	public double getAlpha(Hypothesis aHypothesis) {
