/* Generated By:JavaCC: Do not edit this line. SuggestionParser.java */
...
public class SuggestionParser implements SuggestionParserConstants {
   ...
   */
  static final public void Heuristic(SuggestionHeuristicBuilder aBuilder) throws ParseException {
   String s;
     count = 0;
   ...
   * @throws ParseException 
   */
  static final public String RecurrentStatement(SuggestionHeuristicBuilder aBuilder) throws ParseException {
  String op;
  String eq;
  String cond=null;
...
String e2;
 ...
 Token id;
    ...
    jj_consume_token(40);
    {if (true) return "new lessonMapper.lom.LOMValueSet(\"" + id.image + "\",null)";}
    throw new Error("Missing return statement in function");
  }
...
String s;
    ...
    case LI:
      ...
      jj_consume_token(42);
      att = Attribute();
        {if (true) return "lessonMapper.diffusion.Diffusion.SugVal(li,"+att+")";}
      break;
    case 38:
      jj_consume_token(38);
      e1 = EquationAdd();
...
boolean isPositive=true;
   ...
   * @throws ParseException 
   */
  static final public String FinalEquationAdd(SuggestionHeuristicBuilder aBuilder) throws ParseException {
String theCall;
String op;
String e2;
   ...
   * @throws ParseException 
   */
  static final public String FinalEquationMul(SuggestionHeuristicBuilder aBuilder) throws ParseException {
String theCall;
String op;
String e2;
   ...
   * @throws ParseException 
   */
  static final public String FinalEquationUni(SuggestionHeuristicBuilder aBuilder) throws ParseException {
String id;
String n;
String e1;
String e2;
String s;
  ...
  static final private boolean jj_3R_24() {
    if (jj_scan_token(VI)) return true;
    return false;
  }
   ...
   * 
   */
  static public SuggestionParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x80000000,0x0,0x7f800000,0x80000000,0x1fe000,0x1380,0xc00,0x1380,0xc00,0x601060,0x1000,0x1380,0xc00,0x1ff060,};
   }
   ...
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x10,0x1,0x40,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x148,0x0,0x0,0x0,0x148,};
   }
   ...
   * @param stream 
   */
  public SuggestionParser(java.io.InputStream stream) {
    ...
    token_source = new SuggestionParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
   ...
   * @param stream 
   */
  public SuggestionParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
   ...
   * @param tm 
   */
  public SuggestionParser(SuggestionParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
   ...
   * @param tm 
   */
  public void ReInit(SuggestionParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
